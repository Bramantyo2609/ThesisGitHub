...
void FACTORYIO_init__(FACTORYIO *data__, BOOL retain) {
...
// Code part
void FACTORYIO_body__(FACTORYIO *data__) {
  // Initialise TEMP variables

  __SET_VAR(data__->,CONVEYOR,,(__GET_VAR(data__->STOP_BUTTON,) && (__GET_VAR(data__->CONVEYOR,) || __GET_VAR(data__->START_BUTTON,))));
